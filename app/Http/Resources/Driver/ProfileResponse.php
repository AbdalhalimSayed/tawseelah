    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            "profil"                => [
                ...
                "driver_license"    => asset("storage/".$this->driver_profile->license),
                "id_card"           => asset("storage/".$this->driver_profile->id_card),
            ],
            "car"                   => [
                "id"                => $this->car->id,
                ...
                "license"           => asset("storage/".$this->car->license),
